...
export function Main(){
  ...
  })], [Doc.TextNode("\u2190 Back to Schedule")]), Doc.Element("h1", [Attr.Create("style", "margin: 0;")], [Doc.TextNode("Parking registry")])]), Doc.Element("div", [Attr.Create("style", "text-align: center; margin-top: 10px;")], [Doc.Input([Attr.Create("placeholder", "Text here your car plate"), Attr.Create("style", "margin:5px; padding:5px")], plateNumber())]), Doc.Element("div", [Attr.Create("style", "text-align: center; margin-top: 10px;")], [Doc.BindView((plate) => plate==""?Doc.Element("button", [Attr.Create("style", "margin:10px; padding:10px; background:#ccc; color:#666; border:none; cursor:not-allowed"), Attr.Create("disabled", "disabled")], [Doc.TextNode("Enter plate first")]):Doc.Element("button", [Attr.Create("style", "margin:10px; padding:10px; background:#e67e22; color:white; border:none; border-radius:8px; font-size:16px; cursor:pointer"), Handler("click", () =>() => {
  ...
  })], [Doc.TextNode("\ud83c\udf7f Snacks")]), plateNumber().View)]), Doc.Element("div", [Attr.Create("style", "\r\n                    width: 80%;\r\n                    margin: 30px auto 20px auto;\r\n                    height: 40px;\r\n                    background: black;\r\n                    border-radius: 4px;\r\n                    text-align: center;\r\n                    color: white;\r\n                    font-size: 18px;\r\n                    font-weight: bold;\r\n                    line-height: 40px;\r\n                    letter-spacing: 6px;\r\n                    border: 2px solid #ccc;\r\n                 ")], [Doc.TextNode("SCREEN")]), Doc.Element("div", [Attr.Create("style", "\r\n                     display:grid;\r\n                     grid-template-columns:repeat(10, 80px);\r\n                     gap:10px;\r\n                     justify-content:center;\r\n                     margin-top:30px;\r\n                 ")], ofSeq(delay(() => map_1(spotButton, parkingSpots())))), Doc.Element("h3", [], [Doc.TextView(Map((s) =>"The parking space of your choice: "+s, selectedSpot().View))])]);
}
