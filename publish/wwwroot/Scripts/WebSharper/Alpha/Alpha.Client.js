...
export function Main(){
  ...
  })], [Doc.TextNode("\ud83c\udf7f Snacks")]), plateNumber().View), Doc.Element("h3", [], [Doc.TextView(Map((s) =>"The parking space of your choice: "+s, selectedSpot().View))])]), Doc.Element("div", [Attr.Create("style", "\r\n                    width: 80%;\r\n                    margin: 30px auto 20px auto;\r\n                    height: 40px;\r\n                    background: black;\r\n                    border-radius: 4px;\r\n                    text-align: center;\r\n                    color: white;\r\n                    font-size: 18px;\r\n                    font-weight: bold;\r\n                    line-height: 40px;\r\n                    letter-spacing: 6px;\r\n                    border: 2px solid #ccc;\r\n                 ")], [Doc.TextNode("SCREEN")]), Doc.Element("div", [Attr.Create("style", "\r\n                     display:grid;\r\n                     grid-template-columns:repeat(10, 80px);\r\n                     gap:10px;\r\n                     justify-content:center;\r\n                     margin-top:30px;\r\n                 ")], ofSeq(delay(() => map_1(spotButton, parkingSpots()))))]);
}
